...
def main():
    ...
    # plt.title("Impulse response of reverb with random coefficients")
    ...
    plt.title("Impulse response of reverb (random coeffs in [200, 4000)")
    plt.show()
    ...
    plt.title("Response of feedback filters (random coeffs in [200, 4000]")
    ...
    write_audio_safe("Processed flintstones with random coefficients (reverb 4).wav", samp_rate, result)
